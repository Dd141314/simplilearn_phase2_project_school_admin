<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Add Teachers</h1> </div>
		<!-- Content Row -->
		<div class="row">
			<div class="col-lg-12">
				<form class="addTeachers" id="addTeachers" action="AddTeachers" role="form" method="POST" enctype="multipart/form-data">
					<div class="form-row">
					...
					<div class="form-group">
						<button type="reset" id="resetFormAddTeachers" name="resetFormAddTeachers" class="btn btn-danger">clear</button>
						<button type="submit" id="submitFormAddTeachers" name="submitFormAddTeachers" class="btn btn-primary">Submit</button>
					</div>
				</form>
				<div id="snackbar"></div>
			</div>
	...
	<script src="js/add-teachers.js"></script>
